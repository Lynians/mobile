...
//        manageOverlays = mainActivity.drone.getManageOverlays();
//    }
//
...
//        double altitude;
//        int altitudeType;
//        manageMission = mainActivity.drone.getManageMission();
//        manageMission.clear();
//
...
//
//            if(mainActivity.drone.isRadarActivated()) {
//                altitude = mainActivity.drone.getTerrainAlt();
//                altitudeType = MAV_FRAME.MAV_FRAME_GLOBAL_TERRAIN_ALT;
//            } else {
//                altitude = mainActivity.drone.getManageDroneState().getDroneAltitude();
...
//        ManageMission manageMission = mainActivity.drone.getManageMission();
...
//        double droneAltitude = mainActivity.drone.getManageDroneState().getDroneAltitude();
//
...
//        mainActivity.drone.getManageMission().sendMission();
//        polygonSprayState = PolygonSprayState.PAUSE_MISSION;
//
//        sprayPointList.clear();
